...
// import { useUserStore } from '@/store/userInfo'
  ...
  const emits =  defineEmits(['showHeader'])
  onMounted(() => {
    // console.log(i18n)
  })
  ...
  const asideData = ref([
    {icon: imgUrl.left_icon_1,icon_a:imgUrl.left_icon_1_a,sort:0 ,titleKey: 'msg.aside.newProject', path:'/edit/edit', sub:[]},
    {icon: imgUrl.left_icon_2,icon_a:imgUrl.left_icon_2_a,sort:1 ,titleKey: 'msg.aside.savedProjects', path:'/edit/project', sub:[]},
    {icon: imgUrl.left_icon_3,icon_a:imgUrl.left_icon_3_a,sort:2 ,titleKey: 'msg.aside.customComponent', path:'', sub:[]},
    {icon: imgUrl.left_icon_4,icon_a:imgUrl.left_icon_4_a,sort:3 ,titleKey: 'msg.aside.elementManage', path:'/edit/element', sub:[]},
    {icon: imgUrl.left_icon_5,icon_a:imgUrl.left_icon_5_a,sort:4 ,titleKey: 'msg.aside.formatConversion', path:'/edit/conversion', sub:[]},
  ])
...
<template>
  <div class="header_box base-box bg-box">
    ...
    <div class="header_top flex-fs cu" @click="showHeader">
      <img :src="imgUrl.logo" />
